...
<script>
    ...
    function load(page){
        $.ajax({
            url:"${pageContext.request.contextPath}/store/selectAlloutStore.ajax",
            type:"get",
            dataType:"json",
            data:{"page":page},
            success:function(data){
                ...
                for(var i=0;i<data.list.length;i++){
                    html+="<tr>"+
                        "<td>"+data.list[i].outId+"</td>"+
                        "<td>"+data.list[i].goodsId+"</td>"+
                        "<td>"+data.list[i].empId+"</td>"+
                        "<td>"+data.list[i].outDate+"</td>"+
                        "<td>"+data.list[i].outNum+"</td>"+
                        '<td><a title="删除" href="${pageContext.request.contextPath}/store/deleteOutStore.do?outId='+data.list[i].outId+'">'+
